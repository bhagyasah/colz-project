...
import { Classes, Icon, Menu, MenuDivider, MenuItem, Popover,Position, Button} from "@blueprintjs/core";
...
const MenusExample = () => {
   ...
   <Menu className={`docs-inline-example ${Classes.ELEVATION_1}`}>
                ...
                <Menu className={`docs-inline-example ${Classes.ELEVATION_1}`}>
                    ...
                    <MenuItem  shouldDismissPopover={true} icon="asterisk" text="Miscellaneous">
